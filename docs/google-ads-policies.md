# Google Ads policies — source text

Captured verbatim from the page below. **Do not paraphrase this file.** Everything the
tool asserts about Google's policies should be traceable to a line in here; anything not
supported by it is marked as unverified at the point where it is used.

- Source: <https://support.google.com/adspolicy/answer/6008942?hl=en>
- Title: Google Ads policies - Advertising Policies Help
- Captured: 2026-09-10, saved from a browser and extracted from the saved HTML
- Scope: this is Google's OVERVIEW page. Each policy links to its own detail page,
  and those pages are NOT included here. Sub-policies such as Misleading ad design and
  Clickbait live on those pages and are therefore not sourced by this file.
